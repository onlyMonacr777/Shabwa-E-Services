...
class AppColors {
  ...
  static const Color deepOcean = Color(0xFF0A2E3D);       
  static const Color ocean = Color(0xFF1A5F7A);            
  static const Color shallow = Color(0xFF2E8FAD);        
  static const Color foam = Color(0xFF81D4FA);           
